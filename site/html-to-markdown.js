...
/**
 * HTML to Markdown Converter for TEP-GNSS-MGEX Site
...
class HTMLToMarkdownConverter {
        ...
        try {
            ...
            if (fs.existsSync(versionPath)) {
                ...
                return {
                    ...
                    codename: versionData.codename || 'Suva'
                };
            }
        } catch (e) {
            console.warn('⚠️  Could not read VERSION.json, using defaults');
        }
        return { version: '0.1.0', codename: 'Suva' };
    }
    ...
    generateMarkdownFilename() {
        ...
        // Strip trailing .0 from version (e.g., 0.1.0 -> 0.1)
        const cleanVersion = version.replace(/\.0$/, '');
        return `14-TEP-GNSS-MGEX-v${cleanVersion}-${codename}.md`;
    }
